...
//            String jsonText = readAll(rd);
     ...
     *//*
    public static BigDecimal distance(double lat1, double lat2, double lon1,
        ...
        double roundOff = (double) Math.round(Math.sqrt(distance) * 100) / 100;
        System.out.println( roundOff);

        return new BigDecimal(roundOff);
    }*/
                                  ...
                                  double lon2)
    {
        ...
        // for miles
        double r = 6371;
        double roundOff = (double) Math.round((c*r) * 100) / 100;
        System.out.println(roundOff);
